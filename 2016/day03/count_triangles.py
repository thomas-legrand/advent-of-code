...
def get_input_by_columns(input_path):
    ...
    triangles_by_columns = [triangle[i] for i in range(3) for triangle in triangles]
    return [triangles_by_columns[x:x+3] for x in range(0, len(triangles_by_columns), 3)]
